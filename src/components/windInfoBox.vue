...
<template>
    <div class="bg-slate-300 w-36 md:w-60 rounded-xl p-2">
        <div class="windLabel flex items-center font-semibold gap-3">
            <svg xmlns="http://www.w3.org/2000/svg" class="svg-icon fill-slate-500 overflow-hidden align-middle w-8 h-8"  viewBox="0 0 1024 1024" version="1.1">
        ...
        <div class="windValues text-sm font-semibold ml-2 flex justify-between">
            <div>
